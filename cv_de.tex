...
\cventry{seit 2004}{Software Engineer / IT-Consultant}{mindrunner}{}{}{
  \begin{itemize}
    \item selbstständige Tätigkeit als Softwareentwickler, DevOps Engineer und Berater
  \end{itemize}
}

\cventry{since 2018}{CTO}{eco.income}{}{}{
  \begin{itemize}
    \item Backend Entwicklung
    \item Architektur
    \item DevOps
    \item Mobile App Entwicklung
  \end{itemize}
}
\cventry{2019}{Blockchain / DevOps Engineer}{a-Qube}{}{}{
  \begin{itemize}
    \item CI/CD für diverse Applikationen
    \item Planung Blockchain Landschaft
  \end{itemize}
}

\cventry{2016--2019}{Professional Application Engineer / Build Manager}{SBB CFF FFS}{}{}{
  \begin{itemize}
    \item Entwicklung vollautomatische Build-Pipeline f"ur Android und iOS
    \item Entwicklung von der Next-Gen Continuous integration
    \item Hauptverantwortlicher Continuous Integration
    \item Migration kompletter Infrastruktur zu Amazon AWS
    \item Gilde Software Security
    \item Gilde Qualit"atssicherung
    \item Wartung der Continuous Integration Applikationen
    \item Entwicklung Self Service Portal / Spring Boot
  \end{itemize}
}
...
\section{zertifizierung / schulung}
\cventry{2018}{Zertifizierung}{embarc}{}{}{
  \begin{itemize}
      \item Agile Software Architektur
  \end{itemize}
}
\cventry{2018}{Zertifizierung}{DasScrumTeam}{}{}{
  \begin{itemize}
      \item Scrum Master
  \end{itemize}
}
\cventry{2018}{Schulung}{SBB CFF FFS}{}{}{
  \begin{itemize}
      \item Eisenbahnakademie - Bahn Know-How
  \end{itemize}
}
\cventry{2017}{Zertifizierung}{CloudBees}{}{}{
  \begin{itemize}
...
\cventry{2019--2020}{EcomExperts Shopify Speedchecker}{\textbf{[Node.js, ReactJS]}}{}{https://www.shopifyspeedcheck.com/}{
  \begin{itemize}
    \item Backend Entwicklung in Node.js
    \item Frontend Entwicklung in ReactJS
  \end{itemize}
}
...
\cvline{Spanisch}{Grundlagen}{}
\cvline{Französisch}{Anf"anger}{}
\cvline{Polnisch}{Anf"anger}{}
