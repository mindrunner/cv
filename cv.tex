...
\cventry{since 2004}{Software Engineer / IT-Consultant}{mindrunner}{}{}{
  \begin{itemize}
    \item freelancer in software engineering, DevOps and consulting
  \end{itemize}
}
...
\cventry{2019}{Blockchain / DevOps Engineer}{a-Qube}{}{}{
  \begin{itemize}
    \item CI/CD for various applications
    \item Planning Blockchain landscape
  \end{itemize}
}
...
\cventry{2019--2020}{EcomExperts Shopify Speedchecker}{\textbf{[Node.js, ReactJS]}}{}{https://www.shopifyspeedcheck.com}{
  \begin{itemize}
    \item Backend development in Node.js
    \item Frontend development in ReactJS
  \end{itemize}
}
