...
\email{open@mindrunner.de - cv@lukaselsner.de}
%HOMEPAGE  (optional, ggf. einfach die Zeile löschen!)
\homepage{www.mindrunner.de - www.lukaselsner.de}
...
\cventry{2015}{Master Thesis}{\textbf{[Pyhton, C, Java, VHDL, git, \LaTeX]}}{QUT, Schatz Forensic}{}{
  \begin{itemize}
    ...
    orientated I/O and (possibly voltage variation) to particular pins on the
